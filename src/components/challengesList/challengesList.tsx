                    ...
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Achetez un appareil électronique reconditionné <br /><strong>+200 points</strong></span>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Revendez trois jeux vidéo <br /><strong>+300 points</strong></span>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Nettoyez une plage avec l&apos;association INITIATIVES OCÉANES. <br /><strong>+500 points</strong></span>
                                <span className="labelProgressBar">0%</span>
                                <div className="progressBarContainerChallenge">
                                    <div className="progressBarChallenge" style={{ width: "0%" }}></div>
                                </div>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Faire du bénévolat auprès de la Croix Rouge / les Restos du Coeur.<br /><strong>+500 points</strong></span>
                                <span className="labelProgressBar">0%</span>
                                <div className="progressBarContainerChallenge">
                                    <div className="progressBarChallenge" style={{ width: "0%" }}></div>
                                </div>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Promouvoir 3 de vos actions sur Instagram.<br /><strong>+200 points</strong></span>
