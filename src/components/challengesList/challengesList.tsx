                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Revendez trois jeux vidéo</span>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Effectuez un nettoyage complet et un entretien de votre matériel de jeu (console, PC, manette, etc.) pour prolonger sa durée de vie et améliorer son efficacité.</span>
                                <span className="labelProgressBar">60%</span>
                                <div className="progressBarContainerChallenge">
                                    <div className="progressBarChallenge" style={{ width: "60%" }}></div>
                                </div>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Nettoyez une plage avec l&apos;association INITIATIVES OCÉANES.</span>
                                <span className="labelProgressBar">60%</span>
                                <div className="progressBarContainerChallenge">
                                    <div className="progressBarChallenge" style={{ width: "60%" }}></div>
                                </div>
                ...
                <div className="challengeContainer">
                    <div className="challengeContentContainer">
                        <div className="challenge">
                            ...
                            <div className="thisChallengeContainer">
                                <span className="descrChallenge">Faire du bénévolat auprès de la Croix Rouge / les Restos du Coeur.</span>
                                <span className="labelProgressBar">60%</span>
                                <div className="progressBarContainerChallenge">
                                    <div className="progressBarChallenge" style={{ width: "60%" }}></div>
                                </div>
